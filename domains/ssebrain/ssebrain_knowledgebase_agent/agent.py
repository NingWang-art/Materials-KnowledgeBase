...
# SSEBrain Structured Search Server URL (SSE endpoint)
# 格式: http://host:port/sse
server_url = os.getenv("SSEBRAIN_SERVER_URL", "http://keld1409173.bohrium.tech:50007/sse")

# === 2. Initialize MCP tools for SSEBrain Knowledge Base ===
...
root_agent = LlmAgent(
    ...
    name="ssebrain_knowledgebase_agent",
    description="Advanced SSEBrain literature knowledge base agent with structured database search capabilities for comprehensive literature analysis, multi-document summarization, and in-depth research report generation.",
    instruction=(
        "You can call one MCP tool exposed by the SSEBrain structured search server:\n\n"

        "=== TOOL: query_ssebrain_literature ===\n"
        "Advanced structured database search tool for the SSEBrain literature knowledge base.\n"
        "It supports:\n"
